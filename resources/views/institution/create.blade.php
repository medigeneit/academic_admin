...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Institution<small>Add Institution</small></h1>
        </section>


        <section class="content">
            <div class="row">
                {!! Form::open(['action'=>'InstitutionController@store','files'=>true]) !!}
                <div class="col-xs-9">
                    <div class="box">
                        <!-- form start -->
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" placeholder="Enter Name" id="name" class="form-control" required>
                            </div>

                            <div class="form-group">
                                <label for="password">Address</label>
                                <input type="text" name="address" value="{{ old('address') }}" placeholder="Enter Address"  class="form-control" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('department_id[]', $departments, old('department_id'),['class'=>'select2 form-control','multiple'=>'multiple','required'=>'required']) !!}
                            </div>
