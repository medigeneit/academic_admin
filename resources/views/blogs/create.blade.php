...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                {!! Form::open(['action'=>'BlogsController@store','files'=>true]) !!}
                <div class="col-xs-9">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_desc" required  rows="3"  class="form-control" >{{old('short_desc')}}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Detail</label>
                                <textarea name="detail" cols="40" rows="12"   data-error-container="#editor1_error" class="editor form-control" >{{old('detail')}}</textarea>
                            </div>

                            <div class="form-group">
                                <label>Type</label>
                                {!! Form::select('type', ['' => 'Select Type','Blog' => 'Blog','Scholarship' => 'Scholarship'], old('type'),['class'=>'form-control','required'=>'required']) !!}
                            </div>
