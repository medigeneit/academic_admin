...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Approve Contents <small>Add Approve Contents</small>
            </h1>
        </section>
        ...
        <section class="content">
            <div class="row">
                {!! Form::open(['action'=>'ApproveController@store','files'=>true]) !!}
                <div class="col-xs-9">
                    <div class="box">
                        <input type="hidden" name="institution_type_id" value="11">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="file_content" cols="40" rows="12" id="DetailNews" data-error-container="#editor1_error" class="form-control" ></textarea>
                            </div>
