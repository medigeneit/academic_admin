...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                {!! Form::open(['action'=>['DepartmentsController@update',$departments->id],'method'=>'PUT','files'=>true]) !!}
                <div class="col-xs-9">
                    <div class="box">
                        <!-- form start -->
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ $departments->title }}" placeholder="Enter title" id="name" class="form-control" required>
                            </div>
