    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Add Useful Higher Education</small>
            </h1>
        </section>
        ...
        <section class="content">
            <div class="row">
                {!! Form::open(['action'=>'UsefulHigherEducationController@store','files'=>true]) !!}
                <div class="col-xs-9">
                    <div class="box">
                        <!-- form start -->
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('country_id', $country, old('country_id'),['class'=>'form-control','required'=>'required']) !!}<i></i>
                            </div>
