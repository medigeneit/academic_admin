...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Feedback<small>Edit Feedback</small></h1>
        </section>

        <!-- Main content -->
        <section class="content">
            <div class="row">
                {!! Form::open(['action'=>['FeedbackController@update',$feedback->id],'method'=>'PUT','files'=>true]) !!}
                <div class="col-xs-9">
                    <div class="box">
                        <!-- form start -->
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ $feedback->title }}" placeholder="Enter Title" id="name" class="form-control" required>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Detail</label>
                                <textarea name="detail" cols="40" rows="12" id="DetailNews" data-error-container="#editor1_error" class="form-control" >{{$feedback->detail}}</textarea>
                            </div>
                        </div>
                        <!-- /.box-body -->
