...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                {!! Form::open(['action'=>['SubjectsController@update',$subjects->id],'method'=>'PUT','files'=>true]) !!}
                <div class="col-xs-9">
                    <div class="box">
                        <!-- form start -->
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('institution_type_id[]', $institution_type, $subject_has_type,['class'=>'form-control select2','multiple'=>'multiple']) !!}
                            </div>

                            <div class="form-group">
                                <label for="name">Institution Category</label>
                                @php $institution_category->prepend('Select Institution Category','') @endphp
                                {!! Form::select('institution_category_id', $institution_category, $subjects->institution_category_id,['class'=>'form-control']) !!}
                            </div>

                            <div class="form-group">
                                <label>Clasees</label>
                                {!! Form::select('class_id[]', $classes, $subject_has_class,['class'=>'form-control class2','multiple'=>'multiple']) !!}
                            </div>
