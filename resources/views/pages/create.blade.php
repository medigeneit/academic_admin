                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="detail" cols="40" rows="12"  data-error-container="#editor1_error"  class="editor form-control" ></textarea>
                            </div>
                            <div class="form-group">
                                <label>Template</label>

                                {!! Form::select('template', $templates, old('template'),['class'=>'form-control']) !!}<i></i>
