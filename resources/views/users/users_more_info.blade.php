                ...
                <div class="col-xs-9">
                    <div class="box">
                        ...
                        <div class="box-footer">
                            <button class="btn btn-primary" type="submit">Submit</button>                             <button type="button" class="btn btn-default" onclick="window.history.back();">Back</button> <a href="{{url('employees')}}" class="btn btn-primary">Back</a>
                        </div>
                    </div>
                </div>
